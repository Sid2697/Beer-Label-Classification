...
parser.add_argument('-q', default='images/samuel_adams/query/', help='Path to the query image')
parser.add_argument('-l', default='lookup/samadams_sift.pkl', help='Path to the pre computed descriptors')
